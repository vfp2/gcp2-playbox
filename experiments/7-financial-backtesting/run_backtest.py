...
def main():
    ...
    parser.add_argument("--gcp2", default="experiments/7-financial-backtesting/parquet_out/gcp2")
    parser.add_argument("--market", default="experiments/7-financial-backtesting/parquet_out/market")
    ...
    for sym in tickers:
        ...
        out_dir = os.path.join("experiments/7-financial-backtesting/parquet_out", "backtests", f"symbol={sym}")
